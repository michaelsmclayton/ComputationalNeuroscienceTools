...
class Probe:
    ...
    def __init__(self, probe_id, channels, session_id):
        self.session_id = session_id
        self.probe_id = probe_id
        self.channels = channels.loc[channels.ecephys_probe_id==probe_id]
        self.lfp = None
    ...
    def getLfpCoordinates(self, channels, session):
