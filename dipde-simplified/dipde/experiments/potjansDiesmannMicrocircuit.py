...
# -------------------------------------------------
drivenPopulations = [(5, 'e')] # [(2,'e')]# ((4,'e'), (4,'i'))
driving_firing_rate = 50.0
drivingSynapses = 100
drivingStartTime = '.05'
...
def getMeasurementIndices(tf, dt, drivingStartTime):
    ...
    preDrivePercent = (float(drivingStartTime) - .01) / tf
...
# Set number of synapses frm background to microcircuit
nsyn_background = {
    (23, 'e'): 1600, (23, 'i'): 1500,
    (4, 'e'): 2100, (4, 'i'): 1900,
    (5, 'e'): 2000, (5, 'i'): 1900,
