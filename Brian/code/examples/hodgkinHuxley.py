...
morpho = Cylinder(x=[0, 10]*cm, diameter=2*238*um, n=10, type='axon')
...
Im = conductanceNa + conductanceK + conductanceL: amp/meter**2
conductanceNa = (gNa * m**3 * h) * (ENa-v)  : amp/meter**2
conductanceK = gK * n**4 * (EK-v)   : amp/meter**2
conductanceL = gl * (El - v)    : amp/meter**2
